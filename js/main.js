parcelRequire = function(e, r, t, n) {
    var ageEle = document.getElementById('js-age'),
        birth = document.getElementById('birthday').innerText;
        age = parseInt((new Date() - new Date(birth)) / (1000 * 60 * 60 * 24 * 365));
    ageEle.innerText = isNaN(age)? '永远18' : age;
    ...
    "Bb20": [function(require, module, exports) {
        ...
        function e() {
            ...
            "我很好奇！", "欢迎大家光临星象馆<br>这里有着无论何时永远不会消失<br>美丽的无穷光辉<br>满天的星星等候着大家的到来", 
            "*舒缓的现代音乐*"],
                i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
