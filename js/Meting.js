class MetingJSElement extends HTMLElement {
    ...
    _init() {
      ...
      let keys = [
        ...
        'auto', 'lock',
        'name', 'title', 'artist', 'author', 'url', 'cover', 'pic', 'lyric', 'lrc', 'lrcdefault',
      ]
      this.meta = {}
      for (let key of keys) {
    ...
    _loadPlayer(data) {
      ...
      // do not show lrc default
      if (this.meta.lrcdefault === 'hide') {
        if (!this.aplayer.template.lrcWrap.classList.contains('aplayer-lrc-hide')) {
          this.aplayer.lrc.hide();
        } 
        if (!this.aplayer.template.lrcButton.classList.contains('aplayer-icon-lrc-inactivity')) {
          this.aplayer.template.lrcButton.classList.add('aplayer-icon-lrc-inactivity');
        }
      }
    }
